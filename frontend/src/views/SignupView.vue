...
<div class="signUpLayout">
    ...
    <div class="sighUpPaper">
        ...
        <div class="signupForm">
            <input class="signUpInput" type="text" placeholder="이름 입력" v-model="user.userName">
            <input class="signUpInput" type="text" placeholder="아이디 입력" v-model="user.id">
            <input class="signUpInput" type="password" placeholder="비밀번호 입력" v-model="user.password">
            <input class="signUpInput" type="password" placeholder="비밀번호 확인" v-model="userpwdConfirm">
            <input class="signUpInput" type="text" placeholder="이메일 입력" v-model="user.email">
            <input class="signUpInput" type="text" placeholder="닉네임 입력" v-model="user.nickname">
        </div>
        <div class="signUpBtn">
            <button class="learn-more" @click="register" style="height: 30px;">가입</button>
            <button class="learn-more" @click="movePage" style="height: 30px;">go to login</button>
        </div>
    </div>
</div>
</template>
